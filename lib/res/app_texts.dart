...
class AppTexts {
  ...
  static String setTheDuration = 'Set the duration';
  static String chooseValue = 'Choose a value from 1 minute to 60';
  static String betterExperience = 'Make your sports experience better with our easy-to-use app!';
  static String lorem = '''Lorem ipsum dolor sit amet consectetur. Eu sit aliquam sagittis amet luctus magna sem. Morbi vitae nunc netus neque sed convallis. Turpis dolor eu habitant augue ridiculus dui sit adipiscing. Sit fringilla adipiscing risus vestibulum mattis. Duis placerat viverra vulputate cras vel in nunc imperdiet cursus. Sit dignissim est eu sed quis mauris mauris ultrices. Vestibulum lacinia nunc pellentesque lorem commodo ut. 
